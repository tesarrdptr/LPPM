<%@ Page Title="Publikasi Saya" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Page_Trans_PublikasiSaya.aspx.cs" Inherits="Page_Trans_PublikasiSaya" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div ng-controller="MyCtrl" ng-app="myApp">
            <div id="tableToExport">
                <asp:GridView runat="server" ID="gridData" CssClass="table table-hover table-bordered table-condensed table-striped grid" AllowPaging="true"
                    AllowSorting="false" AutoGenerateColumns="false" DataKeyNames="jpb_id" OnRowCommand="gridData_RowCommand" EmptyDataText="Tidak ada data" PageSize="10" PagerStyle-CssClass="pagination-ys"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="pub_id" HeaderText="Id Publikasi" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" Visible="false" />
    ...
    <asp:Panel runat="server" ID="panelAdd" Visible="false" DefaultButton="btnUpload">
        ...
        <asp:Label runat="server" Text=" *" Style="color: red;"></asp:Label>
        <asp:TextBox ID="txtYear" MaxLength="4" TextMode="Number" runat="server" CssClass="form-control" Width="500" placeholder="Tahun Penulisan" onkeyup="limit(this);" />
        <br />
        <%--<asp:DropDownList
        ...
        <div>
            <asp:Label runat="server" CssClass="control-label" Text="Uplaod Berkas"></asp:Label>
            <asp:Label runat="server" Text=" *" Style="color: red;"></asp:Label>
