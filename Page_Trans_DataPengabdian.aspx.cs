...
public partial class Page_Trans_ProgressPengabdian : System.Web.UI.Page
{
    ...
    protected void loadData()
    {
        ...
        gridData.DataSource = lib2.CallProcedure("stp_GetProgressPengabdianSaya", new string[] { Context.User.Identity.Name, Server.HtmlEncode(txtCari.Text.Trim()), ddStatus.SelectedValue,id });
        gridData.DataBind();
        ddlAddProgress.SelectedValue = id;
    }
    protected void loadJenisDokumenMonev()
    {
        ddlJenisDokumen.DataSource = lib2.CallProcedure("stp_getJenisDokumenMonev2", new string[] { Context.User.Identity.Name });
    ...
    protected void gridData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName != "Page")
        {
            ...
            {
                String id = gridData.DataKeys[Convert.ToInt32(e.CommandArgument.ToString())].Value.ToString();
                lib2.CallProcedure("stp_kirimProgressPenelitian", new String[] { id, Context.User.Identity.Name });
                loadData();
                Response.Redirect("Page_Trans_DataPengabdian?id=" + Request.QueryString["id"]);
            }
        }
    }
