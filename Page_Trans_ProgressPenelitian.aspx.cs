...
public partial class Page_Trans_ProgressPenelitian : System.Web.UI.Page
{
    ...
    protected void getStatusProposal()
    {
        int status;
    ...
    {
        gridproposal.DataSource = lib.CallProcedure("stp_getPenelitianProposalsByOwner", new String[] { Context.User.Identity.Name, ddStatus.SelectedValue, Server.HtmlEncode(txtCari.Text.Trim()) });
    ...
    {
        gridData.DataSource = lib2.CallProcedure("stp_GetProgressPenelitianSaya", new string[] { Context.User.Identity.Name, Server.HtmlEncode(txtCari.Text.Trim()), ddStatus.SelectedValue });
        gridData.DataBind();
    }
