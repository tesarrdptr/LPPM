<%@ Page Title="Master Jenis Publikasi" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Page_Master_JenisPublikasi.aspx.cs" Inherits="Page_Master_JenisPublikasi" %>
    ...
    <asp:UpdatePanel ID="updatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel runat="server" ID="panelData" DefaultButton="btnCari">
                ...
                <asp:GridView runat="server" ID="gridData" CssClass="table table-hover table-bordered table-condensed table-striped grid" AllowPaging="true"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="jpb_for" HeaderText="Role Publikasi" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="jpb_title" HeaderText="Jenis Publikasi" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                      <asp:BoundField DataField="jpb_created_by" HeaderText="Dibuat Oleh" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="jpb_created_date" HeaderText="Dibuat Tanggal" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="jpb_updated_by" HeaderText="Diubah Oleh" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="jpb_updated_date" HeaderText="Diubah Tanggal" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:TemplateField HeaderText="Aksi" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" ID="linkEdit" CommandName="Ubah" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' ToolTip="Ubah Data Jenis Publikasi"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></asp:LinkButton>
                                <%--<asp:LinkButton runat="server" ID="LinkButton1" CommandName="Detil" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' ToolTip="Lihat Detil Jenis Publikasi"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span></asp:LinkButton>--%>
                                <asp:LinkButton runat="server" ID="linkDelete" ToolTip="Hapus Data Jenis Publikasi" data-delete='<%# Eval("jpb_id") %>' data-toggle="modal" data-target="#deleteModal"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
            ...
            <asp:Panel runat="server" ID="panelAdd" Visible="false" DefaultButton="btnSubmitAdd">
                ...
                <div>
                    <asp:Label runat="server" CssClass="control-label" Text="Pilih Role"></asp:Label>
                    <asp:Label runat="server" Text=" *" Style="color: red;"></asp:Label>
                    <asp:RequiredFieldValidator runat="server" ID="ReqJenisPub" ControlToValidate="ddlRole" Text="harus dipilih" ForeColor="Red" ValidationGroup="valAdd" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:DropDownList
                        ID="ddlRole"
            ...
            <asp:Panel runat="server" ID="panelEdit" Visible="false" DefaultButton="btnSubmitEdit">
                ...
                <div class="form-group">
                    <asp:TextBox runat="server" ID="editPub" CssClass="form-control" MaxLength="50" ValidationGroup="valEdit"></asp:TextBox>
                </div>
                <div>
                    <asp:Label runat="server" CssClass="control-label" Text="Pilih Role"></asp:Label>
                    <asp:Label runat="server" Text=" *" Style="color: red;"></asp:Label>
                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="ddlRoleEdit" Text="harus dipilih" ForeColor="Red" ValidationGroup="valEdit" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:DropDownList
                        ID="ddlRoleEdit"
                        CssClass="form-control dropdown"
                        runat="server"
            ...
            <asp:Panel runat="server" ID="panelDetil" Visible="false" DefaultButton="btnSubmitEdit">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group" style="margin-bottom: -10px;">
                            <asp:Label runat="server" CssClass="control-label" Text="Role Publikasi"></asp:Label>
                            <asp:Label runat="server" Text=" *" Style="color: red;"></asp:Label>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Semua bisnis proses yang memakai nama jenis publikasi ini kemungkinan tidak dapat diakses kembali.<br />
                    <br />
                    Apakah Anda yakin?
                </div>
