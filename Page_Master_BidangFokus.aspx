<%@ Page Title="Master Bidang Fokus" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Page_Master_BidangFokus.aspx.cs" Inherits="Page_Master_BidangFokus" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel runat="server" ID="panelData" DefaultButton="btnCari">
                ...
                <asp:GridView runat="server" ID="gridData" CssClass="table table-hover table-bordered table-condensed table-striped grid" AllowPaging="true"
                    AllowSorting="false" AutoGenerateColumns="false" DataKeyNames="bidfok_id" EmptyDataText="Tidak ada data" PageSize="10" PagerStyle-CssClass="pagination-ys"
                    ...
                    <Columns>
                        ...
                        <%--<asp:BoundField DataField="bidfok_id" HeaderText="ID Pubikasi" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />--%>
                        <asp:BoundField DataField="bidfok_name" HeaderText="Deskripsi" NullDisplayText="-" ItemStyle-HorizontalAlign="Left" />
                        <asp:BoundField DataField="bidfok_created_by" HeaderText="Dibuat Oleh" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="bidfok_created_date" HeaderText="Dibuat Tanggal" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="bidfok_updated_by" HeaderText="Diubah Oleh" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="bidfok_updated_date" HeaderText="Diubah Tanggal" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:TemplateField HeaderText="Aksi" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton runat="server" ID="linkDelete" ToolTip="Hapus Data Bidang Fokus" data-delete='<%# Eval("bidfok_id") %>' data-toggle="modal" data-target="#deleteModal"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
