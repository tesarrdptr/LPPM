<%@ Page Title="Proposal" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Page_DaftarProposal.aspx.cs" Inherits="Page_KelolaProposal" EnableEventValidation="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div id="tableToExport">
                <asp:GridView runat="server" ID="gridData" CssClass="table table-hover table-bordered table-condensed table-striped grid" AllowPaging="true"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="prp_approve" SortExpression="prp_approve" HeaderText="Tanggal Dinilai" NullDisplayText="-" ItemStyle-HorizontalAlign="Left" />
                        <%--<asp:BoundField DataField="grd_comment" SortExpression="grd_comment" HeaderText="Komentar" NullDisplayText="-" ItemStyle-HorizontalAlign="Left" />--%>
                        <asp:BoundField DataField="nilai_akhir" SortExpression="nilai_akhir" HeaderText="Nilai" NullDisplayText="-" ItemStyle-HorizontalAlign="Left" />
                        ...
                        <asp:TemplateField HeaderText="Aksi" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" >
                            <ItemTemplate>
                                <asp:LinkButton Visible='<%#Eval("prp_status").ToString() == "3" %>' runat="server" ID="linkLihat" CommandName="Dokumen" ToolTip="Dokumen"><span class="glyphicon glyphicon-list" aria-hidden="true"></span></asp:LinkButton>
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="addJenisID" runat="server" CssClass="form-control" />
                </div>
                <div class="form-group" style="margin-bottom: -10px;">
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <div class="form-group" style="margin-bottom: -10px;">
                            ...
                            <asp:DropDownList runat="server" ID="editMemberDL1" CssClass="form-control" ValidationGroup="valAdd" OnSelectedIndexChanged="editMemberDL1_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>&nbsp;
                        </div>
                        <div class="form-group">
                            <asp:Label runat="server" CssClass="control-label" Text="Anggota Proposal 2"></asp:Label>
                            <asp:DropDownList Enabled="false" runat="server" ID="editMemberDL2" CssClass="form-control" ValidationGroup="valAdd" OnSelectedIndexChanged="editMemberDL2_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                        </div>
                        <div class="form-group">
                            <asp:Label runat="server" CssClass="control-label" Text="Anggota Proposal 3"></asp:Label>
                            <asp:DropDownList Enabled="false" runat="server" ID="editMemberDL3" CssClass="form-control" ValidationGroup="valAdd" OnSelectedIndexChanged="editMemberDL3_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                        </div>
                        <div class="form-group">
                            <asp:Label runat="server" CssClass="control-label" Text="Anggota Proposal 4"></asp:Label>
                            <asp:DropDownList Enabled="false" runat="server" ID="editMemberDL4" CssClass="form-control" ValidationGroup="valAdd" OnSelectedIndexChanged="editMemberDL4_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>&nbsp;
                        </div>
    ...
    <asp:Panel runat="server" ID="panelDokumenMonev" Visible="false">
        <asp:GridView runat="server" ID="GridDokumenMonev" CssClass="table table-hover table-bordered table-condensed table-striped grid" AllowPaging="true"
            AllowSorting="false" AutoGenerateColumns="false" DataKeyNames="monevdoc_id" EmptyDataText="Tidak ada data" PageSize="10" PagerStyle-CssClass="pagination-ys"
            ShowHeaderWhenEmpty="true" OnRowCommand="GridDokumenMonev_RowCommand">
            <PagerSettings Mode="NumericFirstLast" FirstPageText="<<" LastPageText=">>" />
            <Columns>
                ...
                <asp:BoundField DataField="monevdoc_jenis" HeaderText="Jenis Dokumen" NullDisplayText="-" ItemStyle-HorizontalAlign="Left" />

                <asp:TemplateField HeaderText="Aksi" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px">
                    <ItemTemplate>
                        <asp:LinkButton ClientIDMode="Static" runat="server" ID="linkDownload" CommandArgument='<%# Eval("monevdoc_id") %>' Text="Download" CommandName="download" ToolTip="Unduh"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
