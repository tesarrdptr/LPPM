    <%@ Page Title="Progress Penelitian" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Page_Trans_DataProgress.aspx.cs" Inherits="Page_Trans_ProgressPenelitian" %>
    ...
    <asp:Panel runat="server" ID="panelData" DefaultButton="btnCari">
        ...
        <div ng-controller="MyCtrl" ng-app="myApp">
            <div id="tableToExport">
                ...
                <asp:LinkButton runat="server" ID="btnKembali" CssClass="btn btn-default" Text="Batal" OnClick="btnKembali_Click"><span aria-hidden="true" class="glyphicon glyphicon-arrow-left"> Kembali</span></asp:LinkButton>
