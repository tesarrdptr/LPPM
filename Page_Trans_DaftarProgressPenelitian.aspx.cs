...
using SelectPdf;
    ...
    public partial class Page_Trans_DaftarProgressPenelitian : System.Web.UI.Page
    {
        ...
        {
            gridData.DataSource = lib2.CallProcedure("stp_GetProgressPenelitianScored", new string[] { Server.HtmlEncode(txtCari.Text.Trim()) , ddStatus.SelectedValue });
            gridData.DataBind();
        }
