...
using SelectPdf;
    ...
    public partial class Page_DaftarPengabdainDosen : System.Web.UI.Page
    {
        ...
        {
            gridData.DataSource = lib2.CallProcedure("stp_GetDaftarPengabdianDosen", new string[] { Server.HtmlEncode(txtCari.Text).Trim(), Context.User.Identity.Name, ddStatus.SelectedValue });
            gridData.DataBind();
        }
        ...
        {
            dt = lib2.CallProcedure("stp_GetReportProgressPengabdian", new string[] { tglMulai.Text, tglSelesai.Text });
            WritePdf(dt);
        }
        ...
        public void WritePdf(DataTable dt, String file = "")
        {
            ...
            using (var exportData = new MemoryStream())
            {
                ...
                PdfDocument doc = converter.ConvertHtmlString(String.Format(baseHtml, "Laporan Daftar Progress Pengabdian", html), "");
                if (file == "")
                    doc.Save(Response, false, "Laporan_Progress_Pengabdian.pdf");
                else
