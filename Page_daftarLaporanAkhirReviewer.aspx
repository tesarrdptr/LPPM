<%@ Page Title="Daftar Laporan AKhir" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Page_daftarLaporanAkhirReviewer.aspx.cs" Inherits="Page_daftarLaporanAkhirReviewer" %>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="review-content-section">
                    ...
                    <div class="form-group-inner">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <asp:Label class="login2 pull-left" runat="server">Dosen Pembuat</asp:Label>

                            </div>
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                <b>
                                    <asp:Label runat="server" ID="txtDosen"></asp:Label></b>
                            </div>
                        </div>
                    </div>
