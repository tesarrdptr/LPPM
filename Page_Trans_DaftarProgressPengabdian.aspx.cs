...
using SelectPdf;
    ...
    public partial class Page_Trans_DaftarProgressPengabdian : System.Web.UI.Page
    {
        ...
        {
            gridData.DataSource = lib2.CallProcedure("stp_GetProgressPengabdianScored", new string[] { Server.HtmlEncode(txtCari.Text).Trim() ,ddStatus.SelectedValue });
            gridData.DataBind();
        }
