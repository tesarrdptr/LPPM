<%@ Page Title="Daftar Pengabdian Saya" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Page_DaftarPengabdianDosen.aspx.cs" Inherits="Page_DaftarPengabdainDosen" %>
    ...
    <asp:UpdateProgress ID="updateProgress1" runat="server" AssociatedUpdatePanelID="updatePanel1">
        <ProgressTemplate>
          ...
          <asp:Panel runat="server" ID="panelData" DefaultButton="btnCari">
                <asp:LinkButton runat="server" Visible="false" ID="linkCetakLaporan" CssClass="btn btn-primary" OnClick="linkCetakLaporan_Click"><span aria-hidden="true" class="glyphicon glyphicon-print"> Cetak Laporan</span></asp:LinkButton>
                <br /><br />
                ...
                <div class="form-group form-inline">
                 ...
                 <asp:GridView runat="server" ID="gridData" CssClass="table table-hover table-bordered table-condensed table-striped grid" AllowPaging="true"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="prg_id" HeaderText="ID Progress" NullDisplayText="-" ItemStyle-HorizontalAlign="Left" visible="false"/>
