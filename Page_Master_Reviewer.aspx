<%@ Page Title="Master Reviewer" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Page_Master_Reviewer.aspx.cs" Inherits="Page_Master_Reviewer" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel runat="server" ID="panelAdd" Visible="false" DefaultButton="btnSubmitAdd">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlJenis" runat="server" CssClass="form-control dropdown" AutoPostBack="false" />
                </div>
            ...
            <asp:Panel runat="server" ID="panelEdit" Visible="false" DefaultButton="btnSubmitEdit">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlReviewerEdit" runat="server" CssClass="form-control" />
                </div>
                <div class="form-group">
                    <asp:Label runat="server" CssClass="control-label" Text="Jenis"></asp:Label>
                    <asp:Label runat="server" Text=" *" Style="color: red;"></asp:Label>
