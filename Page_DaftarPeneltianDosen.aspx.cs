...
using SelectPdf;
    ...
    public partial class Page_DaftarPeneltianDosen : System.Web.UI.Page
    {
        ...
        {
            gridData.DataSource = lib2.CallProcedure("stp_GetDaftarPenelitianDosen", new string[] { Server.HtmlEncode(txtCari.Text.Trim()), Context.User.Identity.Name, ddStatus.SelectedValue });
            gridData.DataBind();
        }
        ...
        {
            dt = lib2.CallProcedure("stp_GetReportProgressPenelitian", new string[] { tglMulai.Text, tglSelesai.Text });
            WritePdf(dt);
        }
        ...
        public void WritePdf(DataTable dt, String file = "")
        {
            ...
            using (var exportData = new MemoryStream())
            {
                ...
                if (file == "")
                    doc.Save(Response, false, "Laporan_Progress_Penelitian.pdf");
                else
