<%@ Page Title="Master Tanggal" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Page_Master_Tanggal.aspx.cs" Inherits="Page_Master_Tanggal" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel runat="server" ID="panelData" DefaultButton="btnCari">
                ...
                <asp:GridView runat="server" ID="gridData" CssClass="table table-hover table-bordered table-condensed table-striped grid" AllowPaging="true"
                    AllowSorting="false" AutoGenerateColumns="false" DataKeyNames="tgl_id" EmptyDataText="Tidak ada data" PageSize="10" PagerStyle-CssClass="pagination-ys"
                    ...
                    <Columns>
                        ...
                        <%--<asp:BoundField DataField="tgl_id" HeaderText="ID Pubikasi" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />--%>
                        <asp:BoundField DataField="tgl_jenis" HeaderText="Deskripsi Tanggal" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="tgl_mulai" HeaderText="Tanggal Mulai" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="tgl_selesai" HeaderText="Tanggal Selesai" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="tgl_created_by" HeaderText="Dibuat Oleh" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="tgl_created_date" HeaderText="Dibuat Tanggal" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="tgl_updated_by" HeaderText="Diubah Oleh" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="tgl_updated_date" HeaderText="Diubah Tanggal" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
            ...
            <asp:Panel runat="server" ID="panelAdd" Visible="false" DefaultButton="btnSubmitAdd">
                <div class="form-group" style="margin-bottom: -10px;">
                    <asp:Label runat="server" CssClass="control-label" Text="Deskripsi Tanggal"></asp:Label>
                    <asp:Label runat="server" Text=" *" Style="color: red;"></asp:Label>
                    <asp:RequiredFieldValidator runat="server" ID="reqAddTanggal" ControlToValidate="AddTanggal" Text="harus diisi" ForeColor="Red" ValidationGroup="valAdd" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:TextBox runat="server" ID="AddTanggal" CssClass="form-control" MaxLength="50" ValidationGroup="valAdd"></asp:TextBox>&nbsp;
                </div>
                <div class="form-group" style="margin-bottom: -10px;">
            ...
            <asp:Panel runat="server" ID="panelDetil" Visible="false" DefaultButton="btnSubmitEdit">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="form-group" style="margin-bottom: -10px;">
                            <asp:Label runat="server" CssClass="control-label" Text="Tanggal Akhir"></asp:Label>
                            <asp:Label runat="server" Text=" *" Style="color: red;"></asp:Label>
 ...
 <%--                             <asp:Button runat="server" ID="Button2" CssClass="btn btn-primary" Text="Simpan" ValidationGroup="valAdd" OnClick="btnSubmitAdd_Click" />--%>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#AddTanggalMulai').datetimepicker({
                format: 'DD MMMM YYYY'
            });
            $('#AddTanggalSelesai').datetimepicker({
                format: 'DD MMMM YYYY',
                useCurrent: false //Important! See issue #1075
            });
            $("#AddTanggalMulai").on("dp.change", function (e) {
                $('#AddTanggalSelesai').data("DateTimePicker").minDate(e.date);
            });
            $("#AddTanggalSelesai").on("dp.change", function (e) {
                $('#AddTanggalMulai').data("DateTimePicker").maxDate(e.date);
            });
        });
    </script>
