...
public partial class Page_Master_JenisPublikasi : System.Web.UI.Page
{
    ...
    protected void Role()
    {
        ddlRole.Items.Add(new ListItem("--- Pilih Role ---", ""));
        ddlRole.Items.Add(new ListItem("Dosen", "Dosen"));
        ddlRole.Items.Add(new ListItem("Mahasiswa", "Mahasiswa"));
    }

    protected void RoleEdit()
    {
        ddlRoleEdit.Items.Add(new ListItem("--- Pilih Role ---", ""));
        ddlRoleEdit.Items.Add(new ListItem("Dosen", "Dosen"));
        ddlRoleEdit.Items.Add(new ListItem("Mahasiswa", "Mahasiswa"));
    }

    protected void loadData()
    {
        gridData.DataSource = lib.CallProcedure("stp_getDataJenisPublikasi", new string[] { Server.HtmlEncode(txtCari.Text.Trim()) });
        gridData.DataBind();
        hideAlert();
    }
    ...
    protected void btnSubmitAdd_Click(object sender, EventArgs e)
    {
        try
        {
            lib.CallProcedure("stp_createJenisPublikasi", new string[] { Server.HtmlEncode(AddJenisPub.Text.Trim()), Context.User.Identity.Name, ddlRole.SelectedValue });
            btnCancelAdd_Click(sender, e);
            loadData();
            showAlertSuccess("Tambah jenis publikasi berhasil");
        }
        catch (Exception ex)
        {
    ...
    protected void btnSubmitEdit_Click(object sender, EventArgs e)
    {
        try
        {
            lib.CallProcedure("stp_editJenisPublikasi", new string[] { editKode.Text, editPub.Text, Context.User.Identity.Name, ddlRoleEdit.SelectedValue });
            btnCancelEdit_Click(sender, e);
            loadData();
            showAlertSuccess("Ubah jenis publikasi berhasil");
        }
        catch (Exception ex)
        {
            showAlertDanger(ex.Message + " " + ex.StackTrace);
    ...
    protected void gridData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName != "Page")
        {
            ...
            {
                dt = lib.CallProcedure("stp_detailJenisPub", new string[] { id });
                editKode.Text = id;
    ...
    {
        lib.CallProcedure("stp_deleteJenisPublikasi", new string[] { txtConfirmDelete.Text });
        loadData();
        showAlertSuccess("Hapus jenis publikasi berhasil");
    }
