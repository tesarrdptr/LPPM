<%@ Page Title="Progress Pengabdian" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Page_Trans_ProgressPengabdian.aspx.cs" Inherits="Page_Trans_ProgressPengabdian" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel runat="server" Visible="false" ID="panelData" DefaultButton="btnCari">
                ...
                <asp:GridView runat="server" ID="gridproposal" CssClass="table table-hover table-bordered table-condensed table-striped grid" AllowPaging="true"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Aksi" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px">
                            <ItemTemplate>
                                <asp:LinkButton ClientIDMode="Static" href='<%# Page.ResolveUrl("Page_Trans_DataPengabdian?id="+Eval("prp_id").ToString()) %>' runat="server" ID="linkLihat" ToolTip="Ajukan Progress"><span class="glyphicon glyphicon-list" aria-hidden="true"></span></asp:LinkButton>
