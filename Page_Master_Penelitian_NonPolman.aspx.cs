...
public partial class Page_Master_Penelitian : System.Web.UI.Page
{
    ...
    {
        gridData.DataSource = lib.CallProcedure("stp_getHistoryPPNP", new string[] { Server.HtmlEncode(txtCari.Text.Trim()) });
        gridData.DataBind();
        hideAlert();
    }
    ...
    {
        return lib.CallProcedure("stp_getHistoryPPNP", new String[] { Context.User.Identity.Name, Server.HtmlEncode(txtCari.Text.Trim()) });
    }
