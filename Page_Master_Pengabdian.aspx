<%@ Page Title="History Pengabdian" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Page_Master_Pengabdian.aspx.cs" Inherits="Page_Master_Penelitian" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:Panel runat="server" ID="panelData" DefaultButton="btnCari">
        ...
        <div class="form-group form-inline">
            ...
            <asp:LinkButton runat="server" Visible="false" ID="btnCetak" CssClass="btn btn-default" OnClick="btnCetak_Click"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> Cari</asp:LinkButton>
        </div>
        ...
        <asp:GridView runat="server" ID="gridData" CssClass="table table-hover table-bordered table-condensed table-striped grid" AllowPaging="true"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="pp_judul" HeaderText="Judul Pengabdian" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" SortExpression="pp_judul" />
                ...
                <%--<asp:BoundField DataField="pp_tgl_mulai" HeaderText="Tanggal Mulai" NullDisplayText="-" ItemStyle-HorizontalAlign="Center"  />
                <asp:BoundField DataField="pp_tgl_selesai" HeaderText="Tanggal Selesai" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />--%>
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="form-group" style="margin-bottom: -10px;">
                    ...
                    <asp:DropDownList runat="server" ID="AddKetua" CssClass="form-control" MaxLength="50" ValidationGroup="valAdd"></asp:DropDownList>&nbsp;
                </div>
                <div class="form-group" style="margin-bottom: -10px;">
                    ...
                    <asp:DropDownList runat="server" ID="addAnggota" CssClass="form-control" MaxLength="50" ValidationGroup="valAdd"></asp:DropDownList>&nbsp;
                </div>
    ...
    <asp:Panel runat="server" ID="panelDetil" Visible="false" DefaultButton="btnSubmitAdd">
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    <asp:Label runat="server" CssClass="control-label" Text="Jenis Pengabdian"></asp:Label>
                    <asp:Label runat="server" Text=" *" Style="color: red;"></asp:Label>
